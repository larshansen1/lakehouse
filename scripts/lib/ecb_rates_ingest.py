"""Reusable ECB rates ingestion helpers."""
...
class RateRecord:
    """Structured ECB FX record used during ingestion."""
...
def build_parser() -> argparse.ArgumentParser:
    """Create a CLI parser consistent with the legacy script behaviour."""
...
def ingest_ecb_rates(
    *,
    ...
    duckdb_statements.extend(ducklake_attach_statements(env_config))
